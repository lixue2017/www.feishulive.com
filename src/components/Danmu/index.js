...
const Danmu = function(options) { 
  ...
  options.color = options.color?options.color:'#fff';
  ...
  for (let index = 0; index < Math.floor(containerH/40); index++) {
     if(i.indexOf(index) == -1) {
      instance.i = index;
      verticalOffset = index*40+16
      break
     }      
  }
